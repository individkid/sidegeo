...
DEFINE_STAGE(CmnProcess,char,CmnOptioner)
DEFINE_STAGE(CmnProcesser,int,CmnProcess)
...
DEFINE_STAGE(Process,char,Optioner)
DEFINE_STAGE(Processer,int,Process)
...
DEFINE_THREAD(CfgProcess,char,File)
DEFINE_THREAD(CfgProcesser,int,CfgProcess)
