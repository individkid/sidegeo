...
DEFINE_STAGE(Shader,enum Shader,Buffer)
...
DEFINE_STAGE(PcsCmdChar,char,PcsCommand)
DEFINE_STAGE(PcsCmdInt,int,PcsCmdChar)
DEFINE_STAGE(PcsCmdData,enum Data,PcsCmdInt)
DEFINE_STAGE(PcsRender,struct Render,PcsCmdData)
DEFINE_STAGE(PcsBuffer,struct Buffer *,PcsRender)
DEFINE_STAGE(PcsShader,enum Shader,PcsBuffer)
...
DEFINE_STAGE(PcsCoefficient,int,PcsTwInt)
