...
DEFINE_WAIT(Haskells,CmnHaskells,CmnHaskells)
...
DEFINE_SOURCE(HsCommands,CmnCommands,Haskells)
...
DEFINE_SOURCE(ConProcesses,CmnProcesses,ConCommands)
DEFINE_STAGE(ConOption,char,ConProcesses)
DEFINE_STAGE(ConOptioner,int,ConOption)

DEFINE_DEST(Outputs,CmnOutputs,ConProcesses)
