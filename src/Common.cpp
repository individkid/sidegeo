...
DEFINE_STAGE(CslCmdCmd,Command,CslCommands)
DEFINE_STAGE(CslCmdInt,int,CslCmdCmd)
...
DEFINE_STAGE(TwCmdCmd,Command,TwCommands)
DEFINE_STAGE(TwCmdInt,int,TwCmdCmd)
...
DEFINE_STAGE(PcsCmdInt,int,PcsCmdCmd)
DEFINE_STAGE(PcsCmdByte,char,PcsCmdInt)
DEFINE_STAGE(PcsCmdData,enum Data,PcsCmdByte)
...
DEFINE_EXTRA(PcsSignal,struct Signal,PcsState)
DEFINE_EXTRA(PcsSound,struct Sound,PcsSignal)
DEFINE_EXTRA(PcsShape,struct Shape,PcsSound)
