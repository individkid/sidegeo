...
DEFINE_WORK(Command,Command,Commands)
DEFINE_EXTRA(CmdChar,char,Command)
DEFINE_EXTRA(CmdInt,int,CmdChar)
DEFINE_EXTRA(CmdData,enum Data,CmdInt)
DEFINE_EXTRA(Render,struct Render,CmdData)
DEFINE_EXTRA(Buffer,struct Buffer *,Render)
...
DEFINE_EXTRA(TwChar,char,Control)
DEFINE_EXTRA(TwInt,int,TwChar)
DEFINE_EXTRA(Coefficient,int,TwInt)
...
DEFINE_SOURCE(PcsOutputs,CmnOutputs,Commands)
...
DEFINE_SOURCE(ProTimewheels,CmnTimewheels,ProCommands)
