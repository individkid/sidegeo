...
-- nontrivial deducers
-- to find typographic minimum,
-- call equispace on space with itself,
-- and find minimum after rename
equispace :: Duals0 -> Duals0 -> Symmetries
equispace (Duals0 ds0) (Duals0 ds1) =
 f bs0 bs1 mapEmpty setEmpty setEmpty where
...
-- to find typographic minimum,
-- call equitope on polytope with itself,
-- and find minimum after rename
equitope :: Topez0 -> Topez0 -> Symmetries
equitope (Topez0 p0) (Topez0 p1) =
 f bs0 bs1 mapEmpty setEmpty setEmpty where
